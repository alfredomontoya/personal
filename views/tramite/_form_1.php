    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="row">
                    ...
                    <?= $form->field($modelcli, 'nitci_cli')->widget(\yii\jui\AutoComplete::classname(), [
                        'clientOptions' => [
                                ...
                                'select' => new \yii\web\JsExpression ("function( event, ui ) { "
                                        ...
                                        . "$('#cliente-id_cliente').val(ui.item.id); "
                ...
                <div class="col-md-1">
                    <?= $form->field($modelcli, 'id_cliente')->textInput(['disabled' => 'disabled'])->label('Id Cli') ?>
                </div>
                <div class="col-md-5">
            ...
            <div class="row">
                <div class="col-md-6">
                    <?= $form->field($model, 'id_cliente_tra')->textInput(['disabled' => 'disabled']) ?>
                </div>
                <div class="col-md-6">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-12 center-block">
                    <?= $form->field($model, 'canal_tra')->radioList(['ROJO'=>'CANAL ROJO','AMARILLO'=>'CANAL AMARILLO', 'VERDE' => 'CANAL VERDE']) ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <?= $form->field($model, 'glosa_tra')->textarea(['type'=>'textarea', 'maxlength' => true]) ?>
                </div>
            </div>  
