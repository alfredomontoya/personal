...
<div class="cambio-form">
    ...
    <?php $form = ActiveForm::begin(); ?>
        ...
        <div class="form-group">
            <?= Html::submitButton('Guardar', ['class' => 'btn btn-success', 'data-toggle'=>'tooltip', 'data-placement'=>'top', 'title' => 'Guardar registro cambio externo']) ?>
            ...
            <div class="panel-body">
                ...
                <div class='row'>
                    <div class="col-md-4">
                        ...
                        <?= Html::activeHiddenInput($model, "tipo_cam", ['value' => 'EX']) ?>
                    </div>
                </div>
                <div class='row'>
                    <div class="col-md-4">
