...
<div class="receipt-form">
    ...
    <?php foreach ($modelDetails as $i => $modelDetail) : ?>
        <div class="row receipt-detail receipt-detail-<?= $i ?>">
            ...
            <div class="col-md-2">
                <?= $form->field($modelDetail, "[$i]descripcion") ?>
            </div>
            <div class="col-md-2">
                <?= $form->field($modelDetail, "[$i]opcion1")->checkbox() ?>
            </div>
            <div class="col-md-2">
                <?= $form->field($modelDetail, "[$i]opcion2")->checkbox() ?>
            </div>
            <div class="col-md-2">
                <?= $form->field($modelDetail, "[$i]opcion3")->checkbox() ?>
            </div>
            <div class="col-md-1">
                <?= $form->field($modelDetail, "[$i]opcion4")->checkbox() ?>
            </div>
            <div class="col-md-1">
